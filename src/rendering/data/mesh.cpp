...
Mesh Mesh::square()
{
    ...
    return Mesh(square_positions, square_normals, square_uvs, square_indices);
}
...
Mesh Mesh::cube()
{
    ...
    return Mesh(cube_positions, cube_normals, cube_uvs, cube_indices);
}
...
Mesh Mesh::skybox()
{
    ...
    return Mesh(skybox_positions, skybox_normals, skybox_uvs, skybox_indices);
}
