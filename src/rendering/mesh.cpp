...
void Mesh::init()
{
    ...
    glBufferData(GL_ARRAY_BUFFER, 7 * positions.size() * sizeof(float), NULL, GL_STATIC_DRAW);
    ...
    glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, sizeof(float3), (void*)(positions.size() * sizeof(float3)));  
    
    glEnableVertexAttribArray(2);
    glVertexAttribPointer(2, 2, GL_FLOAT, GL_FALSE, sizeof(float2), (void*)((positions.size() + normals.size()) * sizeof(float3)));
